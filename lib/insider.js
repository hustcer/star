...
let querySHLatest = function(option, callback){
...
let querySZLatest = function(option, callback){
...
let queryLatest = function(){

    async.waterfall([getQueryLatestOptions, querySHLatest, querySZLatest], function(err){
