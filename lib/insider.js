...
let displayDetail = function(code, summary, tradings){
    ...
    market === 'sz' ? displaySZTradings(tradings):displaySHTradings(tradings);
};

/**
 * Display ShangHai market insider trading records.
 * @param  {Array} tradings   Insider trading records array
 */
let displaySHTradings = function(tradings){
 ...
 * @param  {Array} tradings   Insider trading records array
 */
let displaySZTradings = function(tradings){
